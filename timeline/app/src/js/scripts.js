...
(function($) {
  ...
  /**
    ...
    * @param {angstyTimeline.TimelineView} view View responsible for rendering.
    * @constructor
    */
   ...
   * @typedef {Object} angstyTimeline.EventBio
  ...
  angstyTimeline.TimelineView = function() {
    /**
     * Timeline data array.
     * @type {?Array.<angstyTimeline.EventBio>}
     */
  ...
  angstyTimeline.TimelineView.prototype.restackItems_ = function() {
    ...
    if ($(blocks[0]).outerWidth() > ($(window).innerWidth() * 0.5)) {
      ...
      (blocks.slice(0, blockLastIndex)).each(function() {
    ...
    blocks.each(function(index) {
      ...
      // Calculate the distance needed to close between above two items to
      // achieve the desired vertical gap between them.
      var gapToClose =
          distanceBetweenTopOfThisDivAndBottomOfPrevDivOnSameColumn -
          verticalGap;
   ...
   * @param {!Array.<angstyTimeline.EventBio>} timelineData Data to populate
   *    timeline with.
   */
  angstyTimeline.TimelineView.prototype.setTimelineData = function(
      timelineData) {
   ...
   * @param {Element} element Element for which to calculate the distance.
   * @private
   * @return {number} The given element's distance from the top of the page.
   */
  angstyTimeline.TimelineView.prototype.getDistanceFromTop_ = function(
      element) {
   ...
   * @private
   * @return {number} Y-value for the lowest viewable point on the page.
   */
  angstyTimeline.TimelineView.prototype.getLowestViewYOnPage_ = function() {
  ...
  angstyTimeline.TimelineView.prototype.maybeShowHiddenItems_ = function() {
    ...
    $('.timeline-block').each(function() {
      if (self.getDistanceFromTop_(this) <
          self.getLowestViewYOnPage_()) {
  ...
  $(document).ready(function() {
    ...
    var timelineController = new angstyTimeline.TimelineController(
        new angstyTimeline.TimelineView());
  });
})(jQuery);
